...
public class Renderer {
    ...
    public static class R3D {
        ...
        static Vec3d transformVec3d(Vec3d in) {
            Camera camera = YolBi4.INSTANCE.getMc().gameRenderer.getCamera();
        ...
        public static void renderActions() {
            Camera c = YolBi4.INSTANCE.getMc().gameRenderer.getCamera();
            Vec3d cp = c.getPos();
    ...
    public static class R2D {
        ...
        public static Vec2f renderTooltip(MatrixStack stack, Color color, double arrowX, double arrowY, double width, double height, boolean renderUpsideDown) {
            double centerX = YolBi4.INSTANCE.getMc().getWindow().getScaledWidth() / 2d;
            /*
            left:
            *           /\
            * --------------
        ...
        public static void beginScissor(double x, double y, double endX, double endY) {
            ...
            float mulScale = (float) YolBi4.INSTANCE.getMc().getWindow().getScaleFactor();
            int invertedY = (int) ((YolBi4.INSTANCE.getMc().getWindow().getScaledHeight() - (y + height)) * mulScale);
        ...
        public static Vec3d getScreenSpaceCoordinate(Vec3d pos, MatrixStack stack) {
            Camera camera = YolBi4.INSTANCE.getMc().getEntityRenderDispatcher().camera;
            Matrix4f matrix = stack.peek().getPositionMatrix();
            int displayHeight = YolBi4.INSTANCE.getMc().getWindow().getHeight();
            ...
            return new Vec3d(
                    target.x / YolBi4.INSTANCE.getMc().getWindow().getScaleFactor(),
                    (displayHeight - target.y) / YolBi4.INSTANCE.getMc().getWindow().getScaleFactor(),
                    target.z
            );
        }
        ...
        public static Vec3d screenSpaceToWorldOffset(double x, double y, double z) {
            ...
            xCopy /= YolBi4.INSTANCE.getMc().getWindow().getFramebufferWidth();
            yCopy /= YolBi4.INSTANCE.getMc().getWindow().getFramebufferHeight();
            xCopy = xCopy * 2.0 - 1.0;
            yCopy = yCopy * 2.0 - 1.0;
