...
public class FontRenderer implements Closeable {
    ...
    public void drawString(MatrixStack stack, String s, float x, float y, float r, float g, float b, float a) {
        drawString(stack, s, x, y, r, g, b, a, false, 0,Color.BLACK);
    }


    public void drawString(MatrixStack stack, String s, float x, float y, float r, float g, float b, float a, boolean gradient, int offset, Color gradientColor) {
    ...
    public void drawGradientString(MatrixStack stack, String s, float x, float y, int offset,Color gradientColor) {
        drawString(stack, s, x, y, 255, 255, 255, 255, true, offset,gradientColor);
    }

    public void drawGradientCenteredString(MatrixStack matrices, String s, float x, float y, int i,Color gradientColor) {
        drawGradientString(matrices, s, x - getStringWidth(s) / 2f, y, i, gradientColor);
    }
